  ...
  execute: async (instance, message, args) => {
    ...
    if (args.length === 0) {
      ...
      if (arg === "yes") {
        ...
        if (!setting) {
          message.reply(
            "You succesfully opted out, if you do NOT type the command again with `cancel` as argument within 30 seconds in THIS channel or this server wherever the bot can read all your entries will be deleted, performing this on another server with kirara will NOT work!"
          );
